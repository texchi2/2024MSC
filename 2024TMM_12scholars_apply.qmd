---
title: "2024 Announcement of Visiting Scholarship"
...
-   Endorsement from **department head and hospital director**

## How To Apply

**Step 1:** Visit \[https://texchi2.github.io/2024MSC/2024TMM_12scholars_apply.html\] and download application form: <a href="docs/ApplicationForm_VisitingScholarship.docx" class="button">Download This File</a>
...
**Step 3:** Submit completed application and supporting documents (Passport copy, Degree/Diploma Certificate, NHPC license, CV with your wish list of courses in Taiwan, and **one recommend letter**) to **TMM offiska in HGH** by 26 February 2024 (deadline)
...
**Step 6:** confirmed scholars could submit

  - proof of work from HGH administration, and

  - health check report (within 3 months) with the following specific tests and screenings:

    - Chest X-ray 

    - Tuberculosis (TB) Sputum Test 

    - Syphilis/VDRL/RPR/TPHA Serology Tests (antibody)

    - Measles and Rubella Serology (antibody)

    - (please  <a href="docs/2024TMM_HGH_form_health-certificate.pdf" class="button"> Download </a> this **health certificate form**)
