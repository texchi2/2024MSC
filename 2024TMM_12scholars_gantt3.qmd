...
%\ganttmilestone{}{6} \\
    \ganttbar[progress=100]{Dr. Nouh Ismail Mohamed (General Surgery) 23 Jun - 20 Sep}{6}{9} \\
%    \ganttbar[progress=100]{Dr. Saed Osman (Orthopedic)}{6}{8} \\
    \ganttbar[progress=100]{Mr. Ahmed Hussein Jama (Nurse, OT director)}{9}{11} \\
...
%    \ganttbar[progress=100]{Dr. Yassin Awil (Orthopedic)}{7}{9} \\
    \ganttbar[progress=100]{Dr. Abdulrahmaan Adoosh Abdulaahi (Resident, Orthopedic)}{6}{9} \\
    \ganttbar[progress=100]{Dr. Hassan Mohamoud Nour (Resident, Orthopedic) 23 Jun - 20 Sep}{6}{9} \\
    ...
    \ganttbar[progress=100]{Dr. Idiris Hassan Dahir (Cardiologist)}{10}{12} \\  % CCU, ICU
