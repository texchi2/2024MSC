...
\ganttgroup{Batch 1}{9}{11} \\
%\ganttmilestone{}{6} \\
    \ganttbar[progress=100]{Dr. Nouh Ismail Mohamed (General Surgery)}{9}{11} \\
%    \ganttbar[progress=100]{Dr. Saed Osman (Orthopedic)}{6}{8} \\
    \ganttbar[progress=100]{Dr. Abdulrahmaan Adoosh Abdulaahi (Resident, Orthopedic)}{10}{12} \\
    \ganttbar[progress=100]{Dr. Hassan Mohamoud Nour (Resident, Orthopedic)}{10}{12} \\
    \ganttbar[progress=100]{Mr. Ahmed Hussein Jama (Nurse, OT director)}{10}{12} \\
...
%    \ganttbar[progress=100]{Dr. Yassin Awil (Orthopedic)}{7}{9} \\
    ...
    \ganttbar[progress=100]{Dr. Adnan Sayid Abdo (General Surgery)}{10}{12} \\
...
%\ganttmilestone{}{9} \\
    \ganttbar[progress=100]{Dr. Saed Mohamed Osman (Resident, Orthopedic)}{8}{9} \\
    \ganttbar[progress=100]{Dr. Mohamed Hassan Nur (Resident, Orthopedic)}{8}{9} \\
