...
\ganttgroup{Batch 2}{8}{10} \\
%\ganttmilestone{}{6} \\

%    \ganttbar[progress=100]{Dr. Saed Osman (Orthopedic)}{6}{8} \\

    \ganttbar[progress=100]{Dr. Abdihamid Mohamed Ali  (Neurosurgery)}{8}{10} \\
    \ganttbar[progress=100]{Mr. Mustafe Muse Mohamed (Technician, Pathology)}{8}{10} \\
    \ganttbar[progress=100]{Dr. Adnan Sayid Abdo (General Surgery)}{8}{10} \\
